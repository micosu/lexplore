...
def load_and_merge_data(engineered_metrics, test_data):
...
def preprocess_features(df):
    ...
    metric_columns = [
        'total_pns', 'total_days_completed', 'missions_started',
        'missions_completed', 'missions_aborted', 'missing_missions',
        'races_started', 'popquizzes_completed', 'total_playtime',
        'days_active', 'assemblesyllables_totalnumbers', 'matchcollocations_totalnumber',
        'matchsentenceblank_totalnumber', 'matchsynonyms_totalnumber', 'unique_words_exposed',
        'avg_interactions_per_word', 'words_with_9plus_exposures', 'trained_count', 
...
if __name__ == "__main__":
    # Load datasets
    basic_metrics = pd.read_csv("during_study/new_results/june11/student_metrics_mod.csv")
    group_analysis = pd.read_csv('group_analysis.csv')

    data, models, importance, corrs = main_analysis(basic_metrics, group_analysis)